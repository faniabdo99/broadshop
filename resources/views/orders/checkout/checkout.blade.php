                    ...
                    <div class="row">
                                ...
                                <form class="row" action="{{route('checkout.post')}}" method="post">
                                    ...
                                    <div id="company-feilds" class="col-md-12 d-none">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('checkout.company_name')">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-3">
                                            ...
                                            <textarea class="form-control" name="order_notes" id="notes" rows="6" placeholder="@lang('checkout.add_notes')"></textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-12 mt-5 mt-lg-0">
                            <div class="border bg-light-4 p-3 p-lg-5">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        @if($CouponDiscount)
                                            <li class="mb-3 border-bottom pb-3 d-flex text-success">
                                                <span class="mr-auto"> @lang('checkout.coupon'): {{$CartItems->first()->applied_coupon}}</span>
                                ...
                                <button class="btn btn-primary btn-animated btn-block">@lang('checkout.porceed_to_payment')</button>
                                </form>
                            </div>
                        </div>
                    </div>
