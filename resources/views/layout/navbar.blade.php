        ...
        <div class="row">
          <div class="col-md-4">
            <ul class="header_list">
              <li><a href="{{route('product.home')}}"><i class="icon fa fa-truck"></i> FREE shipping for orders above 50€</a></li>
            </ul>
          </div>
          <div class="col-md-8">
    ...
    <div class="py-md-4 py-4 d-none d-lg-block d-md-block">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-3 col-sm-6 col-xs-6 d-none d-md-flex align-items-center"> <a class="navbar-brand logo d-none d-lg-block" href="{{route('home')}}"> <img class="img-fluid" src="{{url('public')}}/images/footer-logo.png" alt=""> </a> </div>
