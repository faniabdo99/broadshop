    ...
    <div id="header-wrap">
      <div class="container">
        <div class="row"> 
          <!--menu start-->
          <div class="col">
            <nav class="navbar navbar-expand-lg navbar-light position-static"> <a class="navbar-brand logo" href="index.html"> <img class="img-fluid" src="assets/images/logo.png" alt=""> </a>
...
<!--footer start-->
 ...
 <footer class="py-11 bg-dark-1">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-4"> <a class="footer-logo text-white h2 mb-0" href="index.html"> <img class="img-fluid" src="assets/images/footer-logo.png" alt=""> </a>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="d-flex footer-box">
            ...
            <div>
              ...
              <a class="text-muted font-w-4" href="mailto:themeht23@example.com"> themesground@example.com</a><br>
              <a class="text-muted font-w-4" href="mailto:themeht23@example.com"> flipmarto@example.com</a> </div>
          </div>
        </div>
      ...
      <div class="row text-muted align-items-center pt-9">
        <div class="col-md-7 font-w-4"><small>Copyright ©2021 themesground. All Rights Reserved.</small> </div>
