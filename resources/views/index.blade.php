                                    ...
                                    <div class="row h-100 align-items-center">
                                        <div class="col py-8 pl-0">
                                            <div class="animated3"> 
                                                ...
                                                <br>
                                                <h5 class="dark-red d-inline-block text-white font-w-6">Discount!</h5>
                                                <h1 class="mt-4 text-dark animated3"><span>Use coupon</span><br> NEW_SITE_2021</h1>
                                                <a class="btn btn-primary btn-animated ml-3 mt-4" href="{{route('product.home')}}">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row h-100 align-items-center">
                                        <div class="col py-8 pl-0">
                                            <div class="animated3"> 
                                                ...
                                                <br>
                                                <h5 class="dark-red d-inline-block text-white font-w-6">Scooters</h5>
                                                <h1 class="mt-4 animated3 text-white">Now in broadshop</h1>
                                                <a class="btn btn-primary btn-animated ml-3 mt-4" href="{{route('product.home')}}">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item" data-bg-img="{{url('public')}}/images/electronic/bg/newsletter.jpg">
                                <div class="container h-100">
                                    <div class="row h-100 align-items-center">
                                        <div class="col py-8 pl-0">
                                            <div class="animated3"> 
                                                <span class="dark-yellow d-inline-block text-white mb-0">FEMALE</span>
                                                <br>
                                                <h5 class="dark-red d-inline-block text-white font-w-6">Products</h5>
                                                <h1 class="mt-4 animated3">Now in broadshop</h1>
                                                <a class="btn btn-primary btn-animated ml-3 mt-4" href="{{route('product.home')}}">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 col-md-6">
                            <div class="position-relative rounded overflow-hidden">
                                ...
                                <div class="position-absolute top-50 pl-5">
                                    ...
                                    <!-- Heading -->
                                    <h3 class="text-white font-w-7">Electric <br>
                                        Scooters</h3>
                                    <!-- Link --> <a class="more-link text-white" href="{{route('products' , 'scooters')}}">Shop Now </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 col-md-6 mt-5 mt-md-0">
                            <div class="position-relative rounded overflow-hidden">
                                ...
                                <div class="position-absolute top-50 pl-5">
                                    <h6 class="text-white">Shop</h6>
                                    <!-- Heading -->
                                    <h3 class="font-w-7 text-white">Personal <br>
                                        Care</h3>
                                    <!-- Link -->
                                    <a class="more-link text-white" href="{{route('products' , 'personal-care')}}">Shop Now </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4 col-md-12 mt-5 mt-lg-0 d-md-none d-lg-block">
                            <div class="position-relative rounded overflow-hidden">
                                ...
                                <!-- Body -->
                                <div class="position-absolute top-50 pl-5">
                                    <h6 class="text-dark">Wide Variety</h6>
                                    <!-- Heading -->
                                    <h3 class="font-w-7">View<br>All</h3>
                                    <!-- Link --> <a class="more-link text-dark" href="{{route('product.home')}}">Shop Now </a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="card-info">
                                                ...
                                                <div class="card-footer bg-transparent border-0">
                                                    <div class="product-link d-flex align-items-center justify-content-center">
                                                        <a href="{{route('product.single' ,  [$BSProduct->slug,$BSProduct->id])}}" class="btn-cart btn btn-yellow-dark mx-3">
            ...
            <section class="pb-5 pt-0">
                <div class="container">
                    <div class="product-block product-block-div">
                        <div class="row justify-content-left text-left row_title">
                            <h2 class="mb-0 font-w-5 bg-dark-blue">Hot Deals</h2>
                        </div>
                        <div class="row">
                            <div class="owl-carousel no-pb owl-2" data-dots="false" data-nav="true" data-items="3" data-md-items="2" data-sm-items="1">
                                @forelse ($BestSeller as $BSProduct)
