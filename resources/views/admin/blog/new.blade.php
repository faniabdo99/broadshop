                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="bgc-white p-20 bd">
                                    ...
                                    <div class="mT-30">
                                        <form action="{{route('admin.posts.postNew')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="keywords" value="{{old('keywords') ?? ''}}" placeholder="Enter Keywords Here">
                                            </div>
                                            <div class="form-group">
